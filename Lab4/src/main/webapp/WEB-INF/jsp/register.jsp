...
<form method="post" action="register">
    <table>
        ...
        <tr>
            ...
            <td>
                <div><input type="checkbox" name="ide" value="Visual Studio Code"> Visual Studio Code</div>
                <div><input type="checkbox" name="ide" value="Sublime Text"> Sublime Text</div>
                <div><input type="checkbox" name="ide" value="Eclipse"> Eclipse</div>
                <div><input type="checkbox" name="ide" value="Atom"> Atom</div>
                <div><input type="checkbox" name="ide" value="Intelij Idea"> Intelij Idea</div>
            </td>
        </tr>
        <tr>
            <td>TOEIC Score</td>
        ...
        <tr>
            ...
            <td>
                <textarea name="description" rows="5" style="width: 200px"></textarea>
            </td>
        </tr>
        <tr>
            <td></td>
